    ...
    <main className="theme-guru">
      <section className="mx-auto grid max-w-7xl gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:px-12 lg:py-28">
        <div>
          ...
          <h1 className="mt-5 text-5xl leading-[1.02] font-semibold tracking-[-0.045em] text-balance sm:text-6xl">
            ...
            <br />
            <span className="tool-accent">not the answer.</span>
          </h1>
          ...
          <Button asChild className="tool-button mt-8">
            <Link href="/signup">
              Practice with Guru <ArrowRight className="size-4" />
            </Link>
          </Button>
        </div>
        <ProductVisual product="guru" priority />
      </section>
      ...
      <section className="border-iron bg-workshop/60 border-y">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-12">
          <p className="section-label">What Guru observes</p>
